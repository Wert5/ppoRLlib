...
class MyScheduler(Scheduler):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(fixed_value_or_schedule=0.1234, framework="torch", device=None)
        ...
        if self.use_schedule:
            ...
            self._curr_value = fixed_value_or_schedule[0][1]
    ...
    @override(Scheduler)
    def get_current_value(self) -> float: #TensorType:
